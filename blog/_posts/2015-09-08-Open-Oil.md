...
[Open Oil](http://openoil.net/) believes open data can change extractive industries. With the help of the Crowd, data presented in a jumbled, haphazard mess of PDFs may be pulled together into a coherent, useable  format that presents a holistic picture of an organisation or industry. This possibility represents something quite profound as it provides a method whereby people can hold organisations to account, and insist on transparency and fair play. 
